...
preddir = "/home/lio/Dropbox/MP/chalearn2014/evaluation/results/predsperframetest/"
...
def proc_file(predfile):
	...
	# if False:
		...
		while True:
			...
			cv2.putText(img, "gt:"+str(gt[cur_fr-1]), (0,60), cv2.FONT_HERSHEY_COMPLEX , 1,(255,255,0),2)
			cv2.putText(img, "pred:"+str(predlbl[cur_fr-1]), (0,90), cv2.FONT_HERSHEY_COMPLEX , 1,(255,255,0),2)
