...
if pc=="laptop":
    ...
    src = "/media/lio/64EE5F7C8CC54BFB/chalearn2013/20lbl_32x128x128" # dir of preprocessed data
...
class batch:
    ...
    micro = 4 if pc=="reslab" else 4 # number of samples that fits in memory
...
class files:
    ...
    train = glob(src+'/train/batch_100_*.zip')
